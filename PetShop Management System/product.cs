...
namespace new_pet_shop
{
    public partial class product : Form
    {
        ...
        private void ProductDGV_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmbpcatagory.Text = ProductDGV.SelectedRows[0].Cells[2].Value.ToString();
            txtproductquntity.Text = ProductDGV.SelectedRows[0].Cells[3].Value.ToString();
            txtproductprice.Text = ProductDGV.SelectedRows[0].Cells[4].Value.ToString();
            ...
            {
                Key = Convert.ToInt32(ProductDGV.SelectedRows[0].Cells[1].Value.ToString());
            }
        }
